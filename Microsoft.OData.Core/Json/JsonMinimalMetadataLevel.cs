...
namespace Microsoft.OData.Json
{
    ...
    /// <summary>
    /// Class responsible for logic specific to the JSON minimal metadata level (indicated by "odata.metadata=minimal" in the media type, or lack of an "odata" parameter in a v3 and above request).
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    internal sealed class JsonMinimalMetadataLevel : JsonMetadataLevel
    {
        /// <summary>
        ...
        {
            // For minimal metadata we don't want to change the metadata builder that's currently on the resource because the resource might come from a JSON
