//---------------------------------------------------------------------
// <copyright file="ODataJsonBatchReaderStream.cs" company="Microsoft">
...
namespace Microsoft.OData.Json
{
    ...
    /// <summary>
    /// Class used by the <see cref="ODataJsonBatchReader"/> to read the various pieces of a batch payload
    /// in application/json format.
    /// </summary>
    internal sealed class ODataJsonBatchReaderStream : ODataBatchReaderStream
    {
        /// <summary>
        /// The input context used by the Json reader.
        /// </summary>
        private readonly ODataJsonInputContext inputContext;

        /// <summary>
        /// Constructor.
        /// </summary>
        /// <param name="inputContext">The Json input context.</param>
