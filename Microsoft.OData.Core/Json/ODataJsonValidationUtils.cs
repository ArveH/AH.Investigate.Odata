//---------------------------------------------------------------------
// <copyright file="ODataJsonValidationUtils.cs" company="Microsoft">
...
namespace Microsoft.OData.Json
{
    ...
    /// </summary>
    internal static class ODataJsonValidationUtils
    {
        /// <summary>
        ...
        internal static bool IsOpenMetadataReferencePropertyName(Uri metadataDocumentUri, string propertyName)
        {
            ...
            return ODataJsonUtils.IsMetadataReferenceProperty(propertyName)
