...
namespace Microsoft.OData.Json
{
    ...
    /// </summary>
    internal sealed class JsonMinimalMetadataTypeNameOracle : JsonTypeNameOracle
    {
        /// <summary>
        ...
        internal override string GetResourceTypeNameForWriting(string expectedTypeName, ODataResourceBase resource, bool isUndeclared = false)
        {
            ...
            // We only write entity type names in Json if it's more derived (different) from the expected type name.
