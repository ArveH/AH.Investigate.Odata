//---------------------------------------------------------------------
// <copyright file="JsonTypeNameOracle.cs" company="Microsoft">
...
namespace Microsoft.OData.Json
{
    ...
    /// <summary>
    /// Class responsible for determining the type name that should be written on the wire for entries and values in Json.
    /// </summary>
    internal abstract class JsonTypeNameOracle : TypeNameOracle
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines the type name to write to the payload.  Json type names are only written into the payload for open properties
