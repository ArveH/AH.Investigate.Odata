//---------------------------------------------------------------------
// <copyright file="JsonMetadataLevel.cs" company="Microsoft">
...
namespace Microsoft.OData.Json
{
    ...
    /// <summary>
    /// Class responsible for logic that varies based on the JSON metadata level.
    /// </summary>
    internal abstract class JsonMetadataLevel
    {
        /// <summary>
        ...
        /// <returns>The JSON metadata level being written.</returns>
        ...
        internal abstract JsonTypeNameOracle GetTypeNameOracle();
