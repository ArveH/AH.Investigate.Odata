//---------------------------------------------------------------------
// <copyright file="ODataJsonContextUriParser.cs" company="Microsoft">
...
namespace Microsoft.OData.Json
{
    ...
    internal sealed class ODataJsonContextUriParser
    {
        ...
        private readonly ODataJsonContextUriParseResult parseResult;

        /// <summary>
        /// Initializes a new instance of the <see cref="ODataJsonContextUriParseResult"/> class.
        /// </summary>
        ...
        private ODataJsonContextUriParser(IEdmModel model, Uri contextUriFromPayload)
        {
            ...
            this.model = model;
            this.parseResult = new ODataJsonContextUriParseResult(contextUriFromPayload);
        }
        ...
        internal static ODataJsonContextUriParseResult Parse(
            IEdmModel model,
            ...
            IEdmNavigationSource navigationSource = null)
        {
            ...
            ODataJsonContextUriParser parser = new ODataJsonContextUriParser(model, contextUri);
        ...
        private ODataPayloadKind ParseContextUriFragment(string fragment, Func<IEdmType, string, IEdmType> clientCustomTypeResolver, bool throwIfMetadataConflict, out bool isUndeclared)
        {
            ...
            if (!fragment.Contains(ODataConstants.UriSegmentSeparator, StringComparison.Ordinal) && !hasItemSelector && kind == ODataDeltaKind.None)
            {
                ...
                else if (fragment.Equals(ODataConstants.CollectionPrefixwithEntityReference, StringComparison.Ordinal))
                {
