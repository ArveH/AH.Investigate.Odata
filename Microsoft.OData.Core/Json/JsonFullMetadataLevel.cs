...
namespace Microsoft.OData.Json
{
    ...
    /// <summary>
    /// Class responsible for logic specific to the JSON full metadata level (indicated by "odata.metadata=full" in the media type).
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    internal sealed class JsonFullMetadataLevel : JsonMetadataLevel
    {
        /// <summary>
        /// The Edm model.
        /// </summary>
