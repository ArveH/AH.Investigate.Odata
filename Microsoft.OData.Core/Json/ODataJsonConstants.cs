//---------------------------------------------------------------------
// <copyright file="ODataJsonConstants.cs" company="Microsoft">
...
namespace Microsoft.OData.Json
{
    ...
    /// </summary>
    internal static class ODataJsonConstants
    {
        ...
        /// <summary>
        /// The 'null' property name for the Json value property.
        ...
        /// <summary>The 'error' property name for the Json value property.</summary>
        internal const string ODataErrorPropertyName = "error";

        /// <summary>The 'source' property name for the Json value property.</summary>
        internal const string ODataSourcePropertyName = "source";

        /// <summary>The 'target' property name for the Json value property.</summary>
        internal const string ODataTargetPropertyName = "target";

        /// <summary>The 'relationship' property name for the Json value property.</summary>
        ...
        /// <summary>The 'reason' property name for the Json value property.</summary>
        internal const string ODataReasonPropertyName = "reason";

        /// <summary>The value 'changed' for the Json 'reason' property.</summary>
        internal const string ODataReasonChangedValue = "changed";

        /// <summary>The value 'deleted' for the Json 'reason' property.</summary>
