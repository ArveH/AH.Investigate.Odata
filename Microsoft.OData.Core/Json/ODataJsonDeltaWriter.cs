//---------------------------------------------------------------------
// <copyright file="ODataJsonDeltaWriter.cs" company="Microsoft">
...
namespace Microsoft.OData.Json
{
    ...
    /// <summary>
    /// Implementation of the ODataDeltaWriter for the Json format.
    /// </summary>
    internal sealed class ODataJsonDeltaWriter : ODataDeltaWriter, IODataOutputInStreamErrorListener
    {
        ...
        /// JsonWriter
        /// </summary>
        private readonly ODataJsonWriter resourceWriter;
        ...
        public ODataJsonDeltaWriter(ODataJsonOutputContext jsonOutputContext, IEdmNavigationSource navigationSource, IEdmEntityType entityType)
        {
            ...
            this.resourceWriter = new ODataJsonWriter(jsonOutputContext, navigationSource, entityType, true, writingDelta: true);
